...
async def main():
    async with async_playwright() as p:
        ...
        for idx, msg in enumerate(message_items):
            ...
            # Wait until the detail modal loads (assumed selectors)
            await page_3001.wait_for_selector("#policy-number")

            # 3️⃣ Extract claim details from the opened modal
            ...
            # Clean and convert the claim amount
            ...
            # Optional: log success for each processed claim
